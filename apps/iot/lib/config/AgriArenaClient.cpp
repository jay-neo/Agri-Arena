...
AgriArenaClient::AgriArenaClient(const char *_ntpServer = "pool.ntp.org") : ntpServer(_ntpServer) {}
...
//             %H:%M:%S", &timeinfo); Serial.println(String(timeStringBuff)); // Print the time for debugging
//         }
//     }
// }