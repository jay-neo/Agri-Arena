  ...
  return (
    <div className="">
      <Link
        ...
        className="block container mx-2 w-[22rem] h-32 rounded-2xl bg-sky-200/80 dark:bg-white/5 p-3 shadow-surface-elevation-low transition duration-300 hover:bg-sky-300/80 dark:hover:bg-white/10 dark:hover:shadow-surface-elevation-medium"
      >
        <div>
          ...
          <div className="flex flex-row items-center justify-end h-6">
            {/* <div className="mr-1 items-center">
              <Image src={Recent} alt=":>" className="w-4 dark:invert" />
            </div> */}
            <p className="mt-4 text-sm dark:text-rose-100/ truncate">
