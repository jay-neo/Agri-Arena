...
export const MobileNavBarSection: MobileNavBarItem[] = [
  {
    ...
    path: "/activity",
    icon: (
      <Image src={PhoneNavBarActivity} alt="activity" className="h-6 w-6 dark:invert" />
    ),
  },
  {
    title: "Arena",
    path: "/arena",
    icon: <Image src={PhoneNavBarArena} alt="arena" className="h-6 w-6 dark:invert" />,
  },
  {
    title: "Chat",
    path: "/chat",
    icon: <Image src={PhoneNavBarChat} alt="chat" className="h-6 w-6 dark:invert" />,
  },
  {
    title: "Calendar",
    path: "/events",
    icon: (
      <Image src={PhoneNavBarCalender} alt="calender" className="h-6 w-6 dark:invert" />
    ),
  },
  {
    title: "Social",
    path: "/social",
    icon: <Image src={PhoneNavBarSocial} alt="social" className="h-6 w-6 dark:invert" />,
  },
];
