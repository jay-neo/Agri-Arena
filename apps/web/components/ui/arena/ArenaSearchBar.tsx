...
export const ArenaSearchBar = ({ placeholder }: { placeholder: string }) => {
  ...
  return (
    <form
      className="flex items-center max-w-sm mx-auto mb-3 px-2"
    ...
    >
      <div className="relative w-full">
        ...
        <input
          ...
          id="search"
          name="search"
          className="bg-gray-50  text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-white/5 dark:placeholder-gray-400 dark:text-white focus:outline-none"
